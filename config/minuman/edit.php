...
if($_SERVER['REQUEST_METHOD'] == 'GET'){
 ...
 if ( !isset($_GET["id"]) ){
    ...
    do{
        if( empty($id) || empty($kode) || empty($namaminuman) || empty($deskripsi) || empty($harga) ) {
            $errorMessage = "All the fields are required";
            break;
          }

          $sql = "UPDATE minuman SET kode = '$kode', namaminuman = '$namaminuman', deskripsi = '$deskripsi', harga = '$harga' WHERE id = $id";
