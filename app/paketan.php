...
<body>
    ...
    <div class="wrapper">
        <button class="tambah"><a href="../config/paketan/tambah.php">Tambah Data</a></button>
        <table>
            <tr id="header">
                <th>ID</th>
                <th>Kode</th>
            ...
            <?php 
                ...
                while($row = $result->fetch_assoc()){
                    ...
                    <td>$row[harga]</td>
                    <td>
                    <button class='edit'><a href='../config/paketan/edit.php?id=$row[id]'>Edit</a></button>
                    <button class='hapus'><a href='../config/paketan/hapus.php?id=$row[id]'>Hapus</a></button>
                    </td>
                </tr>";
                }
            ?>
